...
from .obd_message import ELM_R_UNKNOWN, ST
from .obd_message import ECU_ADDR_E
import string
...
class Elm:
    ...
    def handle_request(self, cmd, do_write=False):
        ...
        # Initialize header and cmd variables
        header = None
        org_cmd = cmd
        cmd = cmd.upper().strip()
